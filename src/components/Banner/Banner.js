            ...
            <Container>
                <Row>
                   ...
                   <h1 className = "banner_title">YOUR PET'S<br /><span className = "text-success">BEST </span>FRIEND</h1>
                    ...
                    <Button as = {Link} to = "/about" className="px-5 py-2 d-inline text-uppercase" variant="success">About US</Button>
                    <Button as = {Link} to = "/login" className="px-5 py-2 d-inline text-uppercase ms-2" variant="light">Log In</Button>
                   </Col>
                </Row>
            </Container>
        </div>
